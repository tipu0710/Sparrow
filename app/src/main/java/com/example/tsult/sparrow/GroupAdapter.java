...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.ViewHolder> {
    ...
    public GroupAdapter(List<Messages> mMessageList, Context context) {
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            messageText1 = itemView.findViewById(R.id.message_text_layout1);
            profileImage1 = itemView.findViewById(R.id.message_profile_layout1);
            messageImage1 = itemView.findViewById(R.id.message_image_layout1);
            timeText1 = itemView.findViewById(R.id.time_text_layout1);
